        ...
        <form class="max-w-sm mx-auto" action="{{route('categories.store')}}" method="POST">
            ...
            <div class="ms-auto p-8 bg-indigo-200 border-1 rounded-xl shadow-xl">
                <div class="mb-5">
                    ...
                    <input type="nombre" id="nombre" value="{{@old('nombre')}}" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
